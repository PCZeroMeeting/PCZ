...
<?php echo (($linkRequired) ? '<span style="color:red;display:inline;">*</span>' : ''); ?>
<?php if($fullscreenmode){ echo "<br/>";}?>
<input type="text" id="title" name="title" size="50" placeholder="Place title here.." value="<?php echo !empty($title) ? $title : ''; ?>"/>
<?php echo (($titleRequired) ? '<span style="color:red;display:inline;">*</span>' : ''); ?>
...
<textarea style="display:none;" rows="3" cols="50" id="tags" name="tags" placeholder="Type link tags for easy identification...">
<?php echo !empty($tags) ? $tags : ''; ?>
</textarea>
<?php echo (($tagsRequired) ? '<span style="color:red;display:inline;">*</span>' : ''); ?>
<?php if($fullscreenmode){ echo "<br/>";}?>
<textarea rows="2" cols="50" id="description" name="description" style="<?php if($fullscreenmode){ echo "width:50%;height:50%;";}?>" placeholder="Type description of the link...">
<?php echo !empty($description) ? str_ireplace(array("<br />","<br>","<br/>"), "", $description): ''; ?>
</textarea>
